...
<form action=""  name="frmUser" method="post">
	...
	<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example1">
		<div class="alert alert-success">
			<h2 style="text-align:center; font-family:cursive;">Backup Or Destroy Product</h2>
		</div>
		<thead>
<button type="button" class="btn btn-info" onClick="setUpdateAction();"><i class="fa fa-fw fa-undo" style="margin-right: 5px"></i></button><button type="button" class="btn btn-danger" onClick="setDeleteAction();"><i class="fa fa-fw fa-trash"></i></button>
			<tr>
                  ...
                  <th style="text-align:center; font-family:cursive; font-size:18px; color:blue;">Cost</th>
                  <th style="text-align:center; font-family:cursive; font-size:18px; color:blue;">Price</th>
       ...
       @foreach ($product as $key=> $element)
			...
			<tr>
				...
				<td style="text-align:center; font-family:cursive; font-size:18px;">{{$element->cost}}</td>
				<td style="text-align:center; font-family:cursive; font-size:18px">{{$element->price}}</td>
...
document.frmUser.action = "{{ route('admin.backup.resetproduct') }}";
...
Swal.fire({
  ...
  if (result.value) {
  	...
  	document.frmUser.action = "{{ route('admin.backup.destroyproduct') }}";
    document.frmUser.submit();
    Swal.fire(
      'Deleted!',
