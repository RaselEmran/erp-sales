...
<div class="box box-warning">
            <div class="box-header with-border">
             <button id="addnew" class="btn btn-info">New Reciept</button>
            </div>
          @if(session('msg'))
       ...
       @endif
            ...
            <div class="box-body" style="width: 60%;margin: auto; display: none" id="form_body">
              <form role="form" action="{{route('admin.account.receipt-from')}}" method="post">
              	{{@csrf_field()}}
                <!-- text input -->
                <div class="row">
                	<div class="col-md-6">
...
@foreach($payment as $key=> $all)
    <tr>
      ...
      <td>
       <a href="{{route('admin.account.recedit',$all->id)}}" class="btn btn-info"">Edit</a>
